...
while answer1 != "1" or "2" or "3":
    ...
    if answer1 == "1":
        num1_1 = float(input("What is your number?:"))
        while func_1 != "Square" or "Cube":
            func_1 = input("What is your function?(Square,Cube):")
        math_s()
    if answer1 == "2":
        num1_2 = float(input("What is your first number?:"))
        while func_1 != "+" or "-" or "*" or "/":
            func_2 = input("What is your first function?(+,-,*,/):")
        num2_2 = float(input("What is your second number?:"))
        math_s()
    if answer1 == "3":
        num1_3 = float(input("What is your first number?:"))
        while func_1 != "+" or "-" or "*" or "/":
            func_3 = input("What is your first function?(+,-,*,/):")
        num2_3 = float(input("What is your second number?:"))
        while func_1 != "+" or "-" or "*" or "/":
            func2_3 = input("What is your second function?(+,-,*,/):")
